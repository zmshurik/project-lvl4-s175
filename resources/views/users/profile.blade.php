            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="mb-4" action="{{ route('users.update', ['id' => $user->id]) }}" method="POST">
                        ...
                        <div class="mb-3"><a class="btn btn-info" href="{{ route('password.index')}}">Change password</a></div>
                        <div class="d-flex justify-content-center"><button type="submit" class="btn btn-outline-success">Save changes</button></div>
                    </form>
